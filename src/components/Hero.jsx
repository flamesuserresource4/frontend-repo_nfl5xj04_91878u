        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <h1 className="mt-5 text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-slate-900">
              Web Developer turned <span className="bg-gradient-to-r from-sky-600 via-blue-600 to-indigo-700 bg-clip-text text-transparent">Flutter Mobile Dev</span>
            </h1>
            <p className="mt-5 text-lg text-slate-600 leading-relaxed max-w-xl">
              I craft delightful, performant experiences across web and mobile. Passionate about clean architecture, animations, and shipping products that feel magical.
            </p>
            ...
            <div className="mt-8 flex items-center gap-6 text-slate-600">
              <div className="flex -space-x-2">
                ...
                <img alt="tech" src="https://avatars.githubusercontent.com/u/139426?v=4" className="h-8 w-8 rounded-full border border-white" />
                <img alt="tech" src="https://avatars.githubusercontent.com/u/3171503?v=4" className="h-8 w-8 rounded-full border border-white" />
              </div>
              <p className="text-sm">Worked with React, Node, and Flutter for 5+ years</p>
            </div>
          </div>
